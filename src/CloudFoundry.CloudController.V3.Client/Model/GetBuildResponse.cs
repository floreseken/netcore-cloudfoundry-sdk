...
{
    /// <summary>
    /// Data class used for deserializing the "CloudFoundry.CloudController.V3.Client.BuildsExperimentalEndpoint.GetBuild()" Response
    ...
    public partial class GetBuildResponse : CloudFoundry.CloudController.V3.Client.Data.Base.AbstractGetBuildResponse
    {
    }
}
...
namespace CloudFoundry.CloudController.V3.Client.Data.Base
{
    ...
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class AbstractGetBuildResponse
    {
