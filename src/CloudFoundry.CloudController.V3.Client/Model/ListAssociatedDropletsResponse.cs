...
namespace CloudFoundry.CloudController.V3.Client.Model
{
    ...
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/238/apps__experimental_/list_associated_droplets.html"</para>
    /// </summary>
    public class ListAssociatedDropletsResponse
    {
