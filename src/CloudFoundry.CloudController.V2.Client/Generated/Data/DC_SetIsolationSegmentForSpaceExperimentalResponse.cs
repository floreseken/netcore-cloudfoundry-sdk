...
{
    /// <summary>
    /// Data class used for deserializing the "CloudFoundry.CloudController.V2.Client.SpacesEndpoint.SetIsolationSegmentForSpaceExperimental()" Response
    ...
    public partial class SetIsolationSegmentForSpaceExperimentalResponse : CloudFoundry.CloudController.V2.Client.Data.Base.AbstractSetIsolationSegmentForSpaceExperimentalResponse
    {
    }
}
...
{
    /// <summary>
    /// Base abstract data class used for deserializing the "CloudFoundry.CloudController.V2.Client.SpacesEndpoint.SetIsolationSegmentForSpaceExperimental()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/250/spaces/set_the_isolation_segment_for_a_space_(experimental).html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class AbstractSetIsolationSegmentForSpaceExperimentalResponse : IResponse
    {
        /// <summary>
        ...
        /// <summary> 
        /// <para>The Isolation Segment Url</para>
        /// </summary>
        [JsonProperty("isolation_segment_url", NullValueHandling = NullValueHandling.Ignore)]
        public string IsolationSegmentUrl
        {
            get;
            set;
        }
