...
{
    /// <summary>
    /// Data class used for deserializing the "CloudFoundry.CloudController.V2.Client.EventsEndpoint.ListServiceInstanceBindRouteEvents()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/250/events/list_service_instance_bind_route_events.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public partial class ListServiceInstanceBindRouteEventsResponse : CloudFoundry.CloudController.V2.Client.Data.Base.AbstractListServiceInstanceBindRouteEventsResponse
    {
    }
}
...
{
    /// <summary>
    /// Base abstract data class used for deserializing the "CloudFoundry.CloudController.V2.Client.EventsEndpoint.ListServiceInstanceBindRouteEvents()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/250/events/list_service_instance_bind_route_events.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class AbstractListServiceInstanceBindRouteEventsResponse : IResponse
    {
        /// <summary>
