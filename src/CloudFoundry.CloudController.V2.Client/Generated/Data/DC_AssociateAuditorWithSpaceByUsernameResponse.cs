...
{
    /// <summary>
    /// Data class used for deserializing the "CloudFoundry.CloudController.V2.Client.SpacesEndpoint.AssociateAuditorWithSpaceByUsername()" Response
    ...
    public partial class AssociateAuditorWithSpaceByUsernameResponse : CloudFoundry.CloudController.V2.Client.Data.Base.AbstractAssociateAuditorWithSpaceByUsernameResponse
    {
    }
}
...
{
    /// <summary>
    /// Base abstract data class used for deserializing the "CloudFoundry.CloudController.V2.Client.SpacesEndpoint.AssociateAuditorWithSpaceByUsername()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/250/spaces/associate_auditor_with_the_space_by_username.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class AbstractAssociateAuditorWithSpaceByUsernameResponse : IResponse
    {
        /// <summary>
