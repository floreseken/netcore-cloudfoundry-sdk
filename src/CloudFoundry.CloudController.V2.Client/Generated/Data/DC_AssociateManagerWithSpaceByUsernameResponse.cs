...
{
    /// <summary>
    /// Data class used for deserializing the "CloudFoundry.CloudController.V2.Client.SpacesEndpoint.AssociateManagerWithSpaceByUsername()" Response
    ...
    public partial class AssociateManagerWithSpaceByUsernameResponse : CloudFoundry.CloudController.V2.Client.Data.Base.AbstractAssociateManagerWithSpaceByUsernameResponse
    {
    }
}
...
{
    /// <summary>
    /// Base abstract data class used for deserializing the "CloudFoundry.CloudController.V2.Client.SpacesEndpoint.AssociateManagerWithSpaceByUsername()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/250/spaces/associate_manager_with_the_space_by_username.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class AbstractAssociateManagerWithSpaceByUsernameResponse : IResponse
    {
        /// <summary>
