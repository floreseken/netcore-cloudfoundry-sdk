...
{
    /// <summary>
    /// Data class used for deserializing the "CloudFoundry.CloudController.V2.Client.EventsEndpoint.ListAssociateRoleSpaceEvents()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/250/events/list_associate_role_space_events.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public partial class ListAssociateRoleSpaceEventsResponse : CloudFoundry.CloudController.V2.Client.Data.Base.AbstractListAssociateRoleSpaceEventsResponse
    {
    }
}
...
{
    /// <summary>
    /// Base abstract data class used for deserializing the "CloudFoundry.CloudController.V2.Client.EventsEndpoint.ListAssociateRoleSpaceEvents()" Response
    /// <para>For usage information, see online documentation at "http://apidocs.cloudfoundry.org/250/events/list_associate_role_space_events.html"</para>
    /// </summary>
    [GeneratedCodeAttribute("cf-sdk-builder", "1.0.0.0")]
    public abstract class AbstractListAssociateRoleSpaceEventsResponse : IResponse
    {
        /// <summary>
